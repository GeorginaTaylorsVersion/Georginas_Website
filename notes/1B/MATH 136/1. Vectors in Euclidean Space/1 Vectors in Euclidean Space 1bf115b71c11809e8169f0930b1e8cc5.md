...
Then
$$ proj_{\vec{n}}(\vec{v})=\frac{\vec{v}\cdot\vec{n}}{||\vec{n}||^2}\vec{n} = \frac{1(-2)+2(1)+3(4)}{(-2)^2+1^2+4^2}\begin{bmatrix}-2\\ 1\\ 4\end{bmatrix} = \frac{-2+2+12}{4+1+16}\begin{bmatrix}-2\\ 1\\ 4\end{bmatrix} = \frac{12}{21}\begin{bmatrix}-2\\ 1\\ 4\end{bmatrix}=\begin{bmatrix}-24/21\\ 12/21\\ 48/21\end{bmatrix}=\begin{bmatrix}-8/7\\ 4/7\\ 16/7\end{bmatrix} $$
and
